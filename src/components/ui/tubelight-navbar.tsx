  ...
  return (
    <>
      ...
      {/* Mobile Bottom Navigation is used via the separate MobileBottomNav component in Layout, 
          but we also included a simplified NavBar here if needed. 
          For consistency with the Layout structure, we will rely on Layout's MobileBottomNav, 
          but the NavBar export is kept for potential usage. 
      */}
