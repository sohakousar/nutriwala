...
const ProductCard = ({ product, index = 0 }: ProductCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="relative bg-white rounded-2xl overflow-hidden border border-border/50 shadow-sm hover:shadow-lg hover:border-accent/30 transition-all duration-300">
        ...
        <div className="p-5">
          ...
          {/* Title */}
          <Link to={`/product/${product.slug}`}>
            <h3 className="font-serif font-bold text-lg text-primary group-hover:text-accent transition-colors line-clamp-2 mb-2">
              {product.name}
            </h3>
          </Link>
