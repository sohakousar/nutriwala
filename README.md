...
[Live Demo](https://nutriwala.vercel.app) • [Report Bug](https://github.com/your-username/nutriwala/issues) • [Request Feature](https://github.com/your-username/nutriwala/issues)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/your-username/nutriwala.git
   cd nutriwala
   ```
