      ...
      <div className="container mx-auto">
        <div className="mb-8 flex flex-col justify-between md:mb-14 md:flex-row md:items-end lg:mb-16">
          <div>
            ...
            <p className="text-primary-foreground/70 md:text-lg lg:max-w-xl">
              {description}
            </p>
          </div>
          <div className="mt-8 flex shrink-0 items-center justify-start gap-2">
            <Button
              ...
              className="disabled:pointer-events-auto border-accent/30 text-primary-foreground hover:bg-accent/10"
            >
              ...
              >
                <Link to={item.href} className="group flex flex-col justify-between">
                  <div>
                    ...
                    <div className="mb-2 mt-6 line-clamp-2 text-lg font-semibold text-primary-foreground md:mb-3 md:text-xl lg:text-2xl">
                      {item.title}
                    </div>
                    <div className="mb-4 line-clamp-3 text-sm text-primary-foreground/60 md:mb-6 md:text-base">
                      {item.description}
                    </div>
