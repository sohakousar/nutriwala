  ...
  return (
    <div className="w-full h-full p-4 md:p-10 grid grid-cols-1 md:grid-cols-3 max-w-7xl mx-auto gap-4 relative">
          ...
          <motion.div
            ...
            className={cn(
              ...
              selected?.id === card.id
                ...
                ? "z-40 bg-ink-black/80 rounded-xl h-full w-full"
                : "bg-ink-black/60 rounded-xl h-full w-full"
            )}
      ...
      <motion.div
        ...
        className={cn(
          "absolute h-full w-full left-0 top-0 bg-ink-black opacity-0 z-10",
  ...
  return (
    <div className="bg-transparent h-full w-full flex flex-col justify-end rounded-lg shadow-2xl relative z-[60]">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.6 }}
        className="absolute inset-0 h-full w-full bg-ink-black opacity-60 z-10"
      />
      <motion.div
